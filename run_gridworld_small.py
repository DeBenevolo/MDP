...
target_row = 2;  #0	#target location
target_col = 60; #4
mdp = Gridworld_MDP_Pen_class('instances/gridworld_64x53.png',eps,target_row,target_col,'file',-2);
...
#addpath('/Applications/CPLEX_Studio128/cplex/python/2.7')
#index_opt = 'linprog';
#set VI parameters
...
[V_CVaR,Pol_CVaR,err_CVaR] = VI_CVaR(mdp,Y_set_all,0,tol,maxIter,matlib.repmat(V_Exp,1,Ny),dis);